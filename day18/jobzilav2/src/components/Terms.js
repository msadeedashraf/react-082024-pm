    ...
    <main>
      <section id="terms-section">
        ...
        <p>
          ...
          as well as our privacy policy and any other applicable laws and
          regulations.
        </p>
        <h3>2. Use of Content</h3>
        <p>
          You may use the content on our website for personal and non-commercial
          purposes only. You may not reproduce, modify, distribute, or otherwise
        ...
        <p>
          ...
          including but not limited to sending spam, spreading malware, or
