...
const Main = () => {
  const [items, setItems] = useState([
    ...
    },
    {
      ...
      Location: "Seattle",
      Details:
        "This little trouble maker lives in Seattle with James and loves traveling on adventures with James and tweeting @MotzMonkeys. He by far is an Android fanboy and is getting ready for the new Nexus 6P!",
      Image:
    ...
    },
    {
      ...
      Location: "Phoenix",
      Details:
        "An adorable Monkey who is traveling the world with Heather and live tweets his adventures @MotzMonkeys. His favorite platform is iOS by far and is excited for the new iPhone Xs!",
      Image:
    ...
    },
    {
      ...
      Location: "Seattle",
      Details:
        "An adorable Monkey who is traveling the world with Heather and live tweets his adventures @MotzMonkeys. His favorite platform is iOS by far and is excited for the new iPhone 6s!",
      Image:
  ...
  return (
    <main>
      <ul>
        <h1 class="display-1">Monkey List</h1>
        {items.map((i) => (
          <div class="card mb-3">
            <div class="row g-0">
              <div class="col-md-4">
